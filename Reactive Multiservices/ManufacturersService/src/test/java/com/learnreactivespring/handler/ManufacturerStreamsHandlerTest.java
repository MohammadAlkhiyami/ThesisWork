...
@ActiveProfiles("test")
public class ManufacturerStreamsHandlerTest {
    ...
    public void testStreamAllManufacturers() {
        ...
        Flux<ManufacturerCapped> manufacturerCappedFlux = webTestClient.get().uri(ManufacturersConstants.MANUFACTURERS_STREAM_FUNCTIONAL_END_POINT_V1)
                .exchange()
                .expectStatus().isOk()
