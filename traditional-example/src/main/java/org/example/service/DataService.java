...
public class DataService {
    ...
    public List<Item> fetchAllItems() {
        ResponseEntity<List<Item>> responseEntity = restTemplate.exchange(
                "http://localhost:8085/items", // Assuming "ItemService" is the registered name of the ItemService
                HttpMethod.GET,
                null,
    ...
    public List<Manufacturer> fetchAllManufacturers() {
        ResponseEntity<List<Manufacturer>> responseEntity = restTemplate.exchange(
                "http://localhost:8086/manufacturers", // Assuming "ManufacturerService" is the registered name of the ManufacturerService
                HttpMethod.GET,
                null,
